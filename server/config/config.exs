...
config :instagram, InstagramWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "glHhwVy1MfDvLMCFIEDs5T4515IRXJdaxA+Fgym7Yc9UcwNjVyF5mfAX3f6BULrO",
...
config :instagram, InstagramWeb.Auth.Guardian,
	issuer: "instagram",
	verify_issuer: true,
	secret_key: "elS4GueGIW+cnZUkwEg7Z0n2srDOHf74e5Xepp5zHjueVGTD49K5N6Eu143Y2b5u"
